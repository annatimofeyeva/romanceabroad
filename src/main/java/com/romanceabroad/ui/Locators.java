...
public class Locators {
    ...
    public static final By LINK_SEARCH_AGE_MOBILE = By.xpath("//div[@class='search-param-button mb10']//a");
    ...
    public static final By PORTRAIT_ELEMENT = By.xpath("//div[@id='gallery']//div[@title='Portrait']");
    public static final By PARAGRAPH_1_ELEMENT = By.xpath("//div[@style='text-align: justify;']//p//preceding-sibling::p");
    //Gifts page
    ...
    public static final By REGISTRATION_CHECK_BOX_CONFIRMATION = By.cssSelector("input#confirmation");
