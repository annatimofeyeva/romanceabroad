...
public class PdfAndSplit {
    //test is not passed, because i have no pdf files to compare in the project - just nice to have library
    @Test
    ...
    public void testSplit() {
        String info = "Name, 23";
        String[] phraseSplited= info.split(", ");
        String age = phraseSplited[1];
